...
function BrowserRunner() {
    ...
    this.run = function (test, code) {
        ...
        idoc.writeln("<script type='text/javascript'>");
        idoc.writeln("function finish() {"+globalScopeContents+"}");
        idoc.writeln("</script>");
        ...
        var globals = ["HoursPerDay", "MinutesPerHour", "SecondsPerMinute", "msPerDay", "msPerSecond",
        "msPerMinute", "msPerHour", "date_1899_end", "date_1900_start", "date_1969_end", "date_1970_start",
        "date_1999_end", "date_2000_start", "date_2099_end", "date_2100_start",
        "$LocalTZ", "$DST_start_month", "$DST_start_sunday", "$DST_start_hour", "$DST_start_minutes",
        "$DST_end_month", "$DST_end_sunday", "$DST_end_hour", "$DST_end_minutes",
        "Day", "TimeWithinDay", "DaysInYear", "DayFromYear", "TimeFromYear", "YearFromTime", "InLeapYear", "DayWithinYear", "MonthFromTime",
        "DateFromTime", "WeekDay", "$LocalTZ", "LocalTZA", "DaysInMonth", "GetSundayInMonth", "DaylightSavingTA",
        "LocalTime", "UTC", "HourFromTime", "MinFromTime", "SecFromTime", "msFromTime", "MakeTime",
        "MakeDay", "MakeDate", "TimeClip", "ConstructDate",
        "NotEarlyError",
        "$ERROR", "$FAIL", "$PRINT", "$INCLUDE", "runTestCase", "compareArray", "arrayContains",
        "Test262Error", "dataPropertyAttributesAreCorrect", "accessorPropertyAttributesAreCorrect",
        "isEqual", "ToInteger", "fnExists", "ConvertToFileUrl", "fnSupportsArrayIndexGettersOnObjects",
        ...
        idoc.writeln("\
            interpreter.global.fnGlobalObject = function(){return interpreter.global;};\
            try {\
                interpreter.evaluateInContext(\""+this.convertForEval(code)+"\", 'test', 1, x, function(){}, function(r) {window.onerror(r, null, null);});\
            } catch(e) {\
